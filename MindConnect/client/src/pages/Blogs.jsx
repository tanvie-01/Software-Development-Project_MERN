  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <nav className="bg-gradient-to-r from-blue-600 to-purple-600 shadow-lg p-4 sticky top-0 z-40 text-white">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-4">
            ...
            <Link
              to="/dashboard"
              className="bg-white/20 hover:bg-white/30 px-4 py-1.5 rounded-lg transition font-medium"
            >
              Dashboard
            </Link>
          </div>
      ...
      <div className="bg-gradient-to-br from-indigo-900 to-purple-800 text-white py-20 text-center relative overflow-hidden">
        ...
        <h1 className="text-5xl font-extrabold mb-4 relative z-10">
          Health & Wellness Hub
        </h1>
        <p className="text-xl opacity-90 max-w-2xl mx-auto relative z-10">
          Expert advice, tips, and insights to help you live a balanced and
          happy life.
        </p>
      </div>
      ...
      <div className="container mx-auto p-8 -mt-10 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {blogs.map((blog) => (
            <div
              key={blog._id}
              className="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition duration-300 transform hover:-translate-y-2 border border-gray-100 flex flex-col h-full"
            >
              ...
              <div className="p-8 flex flex-col flex-grow">
                ...
                <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                  ...
                  <Link
                    to={`/blogs/${blog._id}`}
                    className="text-white bg-gradient-to-r from-blue-600 to-purple-600 px-5 py-2 rounded-full text-sm font-bold hover:shadow-lg transition transform hover:scale-105"
                  >
                    Read More
                  </Link>
                </div>
