...
const BlogDetails = () => {
  ...
  if (!blog) return <div className="text-center mt-20 text-xl font-bold text-gray-500">Loading Article...</div>;

  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      <nav className="bg-white shadow-sm p-4 sticky top-0 z-40">
        <div className="container mx-auto flex justify-between items-center">
          <Link to="/" className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">MindConnect</Link>
          <Link to="/blogs" className="text-gray-600 hover:text-blue-600 font-bold">← Back to Blogs</Link>
        </div>
      </nav>
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          <div className="relative h-80 md:h-[400px]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-8">
               <span className="bg-blue-600 text-white px-3 py-1 rounded-full text-xs font-bold w-fit mb-3">MENTAL HEALTH</span>
          ...
          <div className="p-8 md:p-12">
            <div className="flex items-center justify-between border-b border-gray-100 pb-6 mb-8">
               ...
               <p className="text-sm text-gray-500 font-medium">{new Date(blog.createdAt).toLocaleDateString()}</p>
            </div>
